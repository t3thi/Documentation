...
| [Gerrit 95170](https://review.typo3.org/c/Packages/TYPO3.CMS/+/95170), am 10.08.2026 auf `main` gemergt | Korrigiert Vergleichsansichten, die Connected- und Free-Mode-Sprachen kombinieren: Connected-Mode-Inhalte bilden Vergleichszeilen, während jede Free-Mode-Sprache unabhängig dargestellt wird, auch wenn die Default Language keine Inhalte enthält. | Eine klar abgegrenzte Zwischenkorrektur für die aktuellen Modi. Sie bestimmt weder das zukünftige Bearbeitungs- noch das Strukturmodell. |
...
| [Gerrit 94917](https://review.typo3.org/c/Packages/TYPO3.CMS/+/94917) | Patch Set 4; keine aktuelle Code-Review-Stimme; 3 ungelöste Kommentare. | Nein | Verbessert die Vergleichsdarstellung für Free Mode und Mixed Mode. Im Review wurde die Ersetzung durch den inzwischen gemergten Patch 95170 vorgeschlagen, 94917 ist offiziell jedoch weiterhin offen und nicht aufgegeben. |

### Review-positiv und mergefähig

Derzeit erfüllt kein Patch alle Kriterien. Positive Code-Review-Stimmen für 92777 bestehen parallel zu ungelösten Kommentaren. Der Patch verbleibt deshalb unter **Review-Nacharbeit erforderlich**.
