...
Astrid reports on findings from the work on [Patch #83496](https://review.typo3.org/c/Packages/TYPO3.CMS/+/83496). In consultation with Christian Kuhn, Astrid has started to record the current status as part of this patch.

The starting point for Astrid's work was the [WIP patch #83001](https://review.typo3.org/c/Packages/TYPO3.CMS/+/83001) by Christian Kuhn. With his patch, Christian had, among other things, adapted the translation behavior of inline relations of other records to that of Pages. In this context, he noticed a discrepancy when the field `l10n_mode=exclude` is set: A "Translate to XYZ" prefix is appended, although the value should have been adopted 1 to 1.
...
She then agreed the following fix with Christian:
